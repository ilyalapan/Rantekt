...
$(function(){$(".loader_inner").fadeOut(),$(".body_loader").delay(400).fadeOut("slow"),$('a[href^="#to"]').on("click",function(e){e.preventDefault();var n=$(this).attr("href"),t=$(n).offset().top;$("body,html").animate({scrollTop:t},1e3)});new Swiper(".swiper-container-1",{grabCursor:!0,speed:1e3,navigation:{nextEl:".sw1-btn-next",prevEl:".sw1-btn-prev"},autoplay:{delay:5e3}}),new Swiper(".swiper-container-2",{grabCursor:!0,speed:1e3,navigation:{nextEl:".sw2-btn-next",prevEl:".sw2-btn-prev"},autoplay:{delay:5e3,disableOnInteraction:!1}})});